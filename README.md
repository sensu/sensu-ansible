...
- If `sensu_include_plugins` is true (the default), the `static_data_store` variable needs to be set: see http://ansible-sensu.readthedocs.io/en/latest/dynamic_checks/
